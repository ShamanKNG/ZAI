...
class statRezyser(serializers.Serializer):
    rezyser = serializers.CharField()
    liczba_filmow = serializers.IntegerField()

class statOceny(serializers.Serializer):
    tytul = serializers.CharField()
    liczba_ocen = serializers.IntegerField()
